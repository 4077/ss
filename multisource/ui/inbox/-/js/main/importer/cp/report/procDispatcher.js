// head {
var __nodeId__ = "ss_multisource_ui_inbox__main_importer_cp_report_procDispatcher";
    ...
    $.widget(__nodeNs__ + "." + __nodeId__, $.ewma.node, {
        ...
        bindEvents: function () {
            ...
            w.e('ss/multisource/inbox/importStart', function (data) {
                var $importer = $(".ss_multisource_ui_inbox__main_importer_cp_report .importer[pivot_id='" + data.aiPivotId + "']");
        ...
        handleImportXPids: function () {
            ...
            if (o.importXPids) {
                $.each(o.importXPids, function (n, proc) {
                    var $importer = $(".ss_multisource_ui_inbox__main_importer_cp_report .importer[pivot_id='" + proc.aiPivotId + "']");
